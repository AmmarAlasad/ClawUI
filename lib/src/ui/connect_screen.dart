            ...
            children: <Widget>[
              ...
              const ClawCard(
                child: ScreenIntro(
                  ...
                  title:
                      'Save one gateway profile and keep the app usable offline.',
                  description:
                      'Live API calls can be attempted when available, while demo fallback preserves the mobile workflow in offline or undefined-contract environments.',
                ),
              ),
                      ...
                      TextFormField(
                        ...
                        validator: (String? value) {
                          ...
                          if (uri == null ||
                              !uri.hasScheme ||
                              uri.host.isEmpty) {
                            return 'Enter a full URL such as https://gateway.example.com.';
                          }
                          return null;
                        },
                      ),
                      ...
                      FilledButton.icon(
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Connection profile saved.'),
                            ),
                          );
